...
class MotionSequence(Node):
    ...
    def sequence_loop(self):
        ...
        # 3 -> Rotate back to original heading
        ...
        # 4 -> Move forward 0.4m past the obstacle
        ...
        # 5 -> Reset Sequence
            ...
            self.right_lane = not self.right_lane
            self.state = 0
